...
[Step 1](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/blob/main/step_1_extract%20workstep%20sheet.py) is to extract the workstep layer (i.e. '工步层') from the raw data of each battery.  
[Step 2](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/blob/main/step_2_feature%20extraction_adjustable.py) is to extract the required features from the step layers of each battery.  
[Step 3](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/blob/main/step_3_feature%20collection_adjustable.py) is to integrate the features from different batteries with the same material into one or several files.  
