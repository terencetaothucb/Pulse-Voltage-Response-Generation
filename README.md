...
[Step 2](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/step_2_feature_extraction_adjustable.py) is to extract the required features from the step layers of each battery.
[Step 3](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/step_3_feature_collection_adjustable.py) is to integrate the features from different batteries with the same material into one or several files.  
