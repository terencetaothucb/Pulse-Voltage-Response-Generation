...
[Step 1](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/step_1_extract_workstep_sheet.py) is to extract the workstep layer (i.e. '工步层') from the raw data of each battery.  
[Step 2](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/step_2_feature extraction_adjustable.py) is to extract the required features from the step layers of each battery.
[Step 3](https://github.com/terencetaothucb/Pulse-Voltage-Response-Generation/step_3_feature collection_adjustable.py) is to integrate the features from different batteries with the same material into one or several files.  
